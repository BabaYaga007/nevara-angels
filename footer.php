                    ...
                    <div class="row">
                        <div class="banner-slider owl-carousel">
                            ...
                            <div class="single-banner">
                                <a href="#"><img src="img/banner-slider/1.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                                <a href="#"><img src="img/banner-slider/2.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                               <a href="#"><img src="img/banner-slider/3.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                                <a href="#"><img src="img/banner-slider/4.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                                <a href="#"><img src="img/banner-slider/5.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                                <a href="#"><img src="img/banner-slider/6.webp" alt="banner-image"></a>
                            </div>
                            <!-- Single Banner End -->
                            <!-- Single Banner Start -->
                            <div class="single-banner">
                          ...
                          <div class="row">
                            ...
                            <div class="single-footer col-lg-3 col-md-6">
                                <div class="footer-logo">
                                    <a href="#"><img class="img" src="img/logo/logo1.png" alt="logo-img"  width="115px"></a>
                                </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="container-footer ptb-30">
                        <div class="row">
                            <div class="col-md-7">
                                <p class="text-md-start copyright-text">Copyright ©  <a target="_blank" href="#">Angels</a> All Rights Reserved.</p>
                            </div>
                            <div class="col-md-5">
