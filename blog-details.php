                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="blog-details">
                            <div class="blog-img">
                                <img src="img/products-banner/5.webp" alt="blog-image">
                            </div>
                            <div class="post-info">
                            ...
                            <div class="blog-img blog-single-img">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="img/products-banner/1.webp" alt="blog-image">
                                    </div>
                                    <div class="col-md-6">
                                        <img src="img/products-banner/10.webp" alt="blog-image">
                                    </div>
                                </div>
                            </div>
                            <p class="mb-20">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p>
                            ...
                            <div class="blog-share mtb-50">
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-7 col-md-6">
                                        <div class="social-links text-md-end mt-2 mt-md-0">
                        ...
                        <div class="blog-related-post recent-post">
                            <h3 class="sidebar-title mt-40">related post</h3>
                            <div class="row">
                                <!-- Single Blog Realated Post Start -->
                                <div class="col-md-4">
                                    <div class="single-related-post">
                                       <a href="#"><img src="img/new-products/1_1.webp" alt="singel-post"></a>
                                       <div class="single-content mt-20">
                                           <h3 class="mb-10"><a href="#">EODEM MODO TYPI, QUI NUNC NOBIS</a></h3>
                                ...
                                <div class="col-md-4">
                                    <div class="single-related-post">
                                        <a href="#"><img src="img/new-products/1_2.webp" alt="singel-post"></a>
                                        <div class="single-content mt-20">
                                           <h3 class="mb-10"><a href="#">EODEM MODO TYPI, QUI NUNC NOBIS</a></h3>
                                           <span>August 1, 2021</span>
                                       </div>
                                ...
                                <div class="col-md-4">
                                    <div class="single-related-post">
                                        <a href="#"><img src="img/new-products/2_1.webp" alt="singel-post"></a>
                                        <div class="single-content mt-20">
                                           <h3 class="mb-10"><a href="#">EODEM MODO TYPI, QUI NUNC NOBIS</a></h3>
                                           <span>August 1, 2021</span>
                                       </div>
                        ...
                        <div class="comment-area recent-post">
                            <h3 class="sidebar-title">3 COMMENTS</h3>
                            <!-- Single Comment Start -->
                            <div class="single-comment">
                                <div class="comment-img f-left pr-30">
                                    <img src="img/blog/4.webp" alt="blog-comment">
                                </div>
                                <div class="comment-details fix">
                                    <h4><a href="#">RICE JOHNNY</a></h4>
                                    <span>August 10, 2021 at 11:08 am</span>
                            ...
                            <div class="single-comment">
                                ...
                                <div class="comment-details fix">
                                    <h4><a href="#">RICE JOHNNY</a></h4>
                                    <span>August 10, 2021 at 11:08 am</span>
                                    <p>explain to you how all this mistaken idea of denouncing pleas praising pain born and I will give you a complete account of the system</p>
                                </div>
                                <a class="reply" href="#">reply</a>
                            </div>
                            <!-- Single Comment End -->
                            <!-- Single Comment Start -->
                            <div class="single-comment ml-20">
                                <div class="comment-img f-left pr-30">
                                    <img src="img/blog/4.webp" alt="blog-comment">
                                </div>
                                <div class="comment-details fix">
                                    <h4><a href="#">MISTAKEN</a></h4>
                                    <span>August 10, 2021 at 11:09 am</span>
                                    <p>mistaken explain to you how all this mistaken idea of denouncing pleas praising pain born and I will give you a complete account of the system</p>
                                </div>
                                <a class="reply" href="#">reply</a>
                            </div>
                            <!-- Single Comment End -->
                        ...
                        <div class="contact-email-area">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <form id="contact-form" class="contact-form" action="https://template.hasthemes.com/Angels/Angels/mail.php" method="post">
                       ...
                       <!-- Compare Products Start -->
                        <div class="compare-products">
                            <div class="search-box-view fix blog-search">
                                <form action="#">
                                    <input type="text" class="email" placeholder="Search here..." name="email" id="search-email">
                        ...
                        <div class="recent-post">
                            <h3 class="sidebar-title mt-40">recent posts</h3>
                            <ul>
                                <!-- Singel Post Thumb Start -->
                                <li class="post-thumb fix">
                                    <div class="left-post-thumb f-left mr-20 mb-20">
                                        <a href="#"><img class="img" src="img/new-products/10_2.webp" alt="latest-post-imgae"></a>
                                    </div>
                                    <div class="right-post-thumb fix">
                                        <h4><a href="#">IPSUM ERAE ON THE INTERNET.</a></h4>
                                ...
                                <li class="post-thumb fix">
                                    <div class="left-post-thumb f-left mr-20 mb-20">
                                        <a href="#"><img class="img" src="img/new-products/2_1.webp" alt="latest-post-imgae"></a>
                                    </div>
                                    <div class="right-post-thumb fix">
                                        <h4><a href="#">IPSUM ERAE ON THE INTERNET.</a></h4>
                                        <span>August 10, 2021</span>
                                ...
                                <li class="post-thumb fix">
                                    <div class="left-post-thumb f-left mr-20 mb-20">
                                        <a href="#"><img class="img" src="img/new-products/2_2.webp" alt="latest-post-imgae"></a>
                                    </div>
                                    <div class="right-post-thumb fix">
                                ...
                                <li class="post-thumb fix">
                                    <div class="left-post-thumb f-left mr-20">
                                        <a href="#"><img class="img" src="img/new-products/3_2.webp" alt="latest-post-imgae"></a>
                                    </div>
                                    <div class="right-post-thumb fix">
                                        <h4><a href="#">IPSUM ERAE ON THE INTERNET.</a></h4>
                                        <span>August 10, 2021</span>
