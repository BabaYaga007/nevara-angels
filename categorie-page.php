                                            ...
                                            <div class="main-single-product row">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps1.jpeg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                                            </div>
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="thubnail-desc fix">
                                                        <h4 class="product-header"><a href="product-page.php">Carte Postal Clock</a></h4>
                                                        <!-- Product Price Start -->
                                            ...
                                            <div class="main-single-product row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps2.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                                ...
                                                <div class="col-md-8">
                                                    <!-- Product Content Start -->
                                                    <div class="thubnail-desc fix">
                                                        <h4 class="product-header"><a href="product-page.php">Modern Desk Lamp</a></h4>
                                                        <!-- Product Price Start -->
                                                        <div class="pro-price mb-15">
                                                            <ul class="pro-price-list">
                                            ...
                                            <div class="main-single-product row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps3.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                                ...
                                                <div class="col-md-8">
                                                    <!-- Product Content Start -->
                                                    <div class="thubnail-desc fix">
                                                        <h4 class="product-header"><a href="product-page.php">Congue Sitamet</a></h4>
                                                        <!-- Product Price Start -->
                                                        <div class="pro-price mb-15">
                                                            <ul class="pro-price-list">
                                            ...
                                            <div class="main-single-product row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps4.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                                ...
                                                <div class="col-md-8">
                                                    <!-- Product Content Start -->
                                                    <div class="thubnail-desc fix">
                                                        <h4 class="product-header"><a href="product-page.php">Nulla Massa Est</a></h4>
                                                        <!-- Product Price Start -->
                                                        <div class="pro-price mb-15">
                                                            <ul class="pro-price-list">
                                            ...
                                            <div class="main-single-product row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps5.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                            ...
                                            <div class="main-single-product row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps6.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick
                                                                    view</a>
                                                ...
                                                <div class="col-md-8">
                                                    <!-- Product Content Start -->
                                                    <div class="thubnail-desc fix">
                                                        <h4 class="product-header"><a href="product-page.php">Placerat Volutpat</a></h4>
                                                        <!-- Product Price Start -->
                                                        <div class="pro-price mb-15">
                                                            <ul class="pro-price-list">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps1.jpeg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps2.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                        ...
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Sheepskin Pillow2</a></h4>
                                                            <p class="price"><span>$241.99</span></p>
                                                            <div class="action-links2">
                                                                <a data-bs-toggle="tooltip" title="Add to Cart" href="cart.php">add to cart</a>
                                                            </div>
                                                        </div>
                                                        <!-- Product Content End -->
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps2.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps3.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Modern Desk Lamp</a></h4>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps3.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps4.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Carte Postal Clock</a></h4>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps4.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps5.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Nulla massa est</a></h4>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps5.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps6.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">congue sitamet</a></h4>
                                                            <p class="price"><span>$241.99</span></p>
                                                            <div class="action-links2">
                                                                <a data-bs-toggle="tooltip" title="Add to Cart" href="cart.php">add to cart</a>
                                                            </div>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps6.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps7.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Splacerat volutpat</a></h4>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="product-page.php">
                                                                <img class="primary-img" src="img/Lamps/pendant_lamps/pendant_lamps7.jpg" alt="single-product">
                                                                <img class="secondary-img" src="img/Lamps/pendant_lamps/pendant_lamps8.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">dictum idrisus</a></h4>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="product-page.php">Maple Wood Table</a></h4>
                        ...
                        <aside class="categorie-sidebar mb-100">
                            ...
                            <div class="categorie-module mb-80">
                                ...
                                <ul class="categorie-list">
                                    <li class="active"><a href="#">Lamps (19)</a>
                                        <ul class="sub-categorie pl-30">
                                            <li><a href="#">Table Lamps (19)</a></li>
                                            <li><a href="#">Pendant lamps (19)</a></li>
                                            <li><a href="#">Wall Lamps (19)</a></li>
                                            <li><a href="#">Floor Lamps (19)</a></li>
                                        </ul>
                                    </li>
