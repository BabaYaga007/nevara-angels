                                        ...
                                        <div class="col-lg-5 col-md-6">
                                            ...
                                            <div class="tab-content">
                                                <div id="thumb1" class="tab-pane fade show active">
                                                    <img src="img/new-products/1_1.webp" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb2" class="tab-pane fade">
                                                    <img src="img/new-products/1_2.webp" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb3" class="tab-pane fade">
                                                    <img src="img/new-products/2_1.webp" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb4" class="tab-pane fade">
                                                    <img src="img/new-products/2_2.webp" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb5" class="tab-pane fade">
                                                    <img src="img/new-products/3_1.webp" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb6" class="tab-pane fade">
                                                    <img src="img/new-products/3_2.webp" alt="product-thumbnail"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-thumbnail mt-15 mb-20">
                                                <div class="thumb-menu nav owl-carousel">
                                                    <div>
                                                        <a class="active" data-bs-toggle="tab" href="#thumb1"> <img src="img/new-products/1_1.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-bs-toggle="tab" href="#thumb2"> <img src="img/new-products/1_2.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-bs-toggle="tab" href="#thumb3"> <img src="img/new-products/2_1.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-bs-toggle="tab" href="#thumb4"> <img src="img/new-products/2_2.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-bs-toggle="tab" href="#thumb5"> <img src="img/new-products/3_1.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-bs-toggle="tab" href="#thumb6"> <img src="img/new-products/3_2.webp" alt="product-thumbnail"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Thumbnail image end -->
